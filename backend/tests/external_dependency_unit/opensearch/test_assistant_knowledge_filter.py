...
class TestAssistantKnowledgeFilter:
    ...
    def test_persona_id_added_when_knowledge_scope_exists(self) -> None:
        """persona_id should be OR'd into the knowledge scope filter
    ...
    def test_persona_id_alone_creates_knowledge_scope(self) -> None:
        """persona_id IS a primary knowledge scope trigger — a persona
    ...
    def test_knowledge_filter_with_document_sets_and_persona(self) -> None:
        """document_sets and persona_id should be OR'd together in
        ...
        ), f"Expected persona_id {PERSONA_ID} in knowledge filter"

...
class LumAppsConnector(CheckpointedConnector[LumAppsCheckpoint], SlimConnector):
    """Ingests LumApps content (pages/news/custom) into Flintyst.

    Carries over **all** LumApps metadata families as Flintyst metadata
    ...
    visible to all Flintyst users regardless of the original LumApps audience. It is not a

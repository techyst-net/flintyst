"""Async HTTP client for communicating with Flintyst API pods."""
...
class OnyxAPIClient:
    """Async HTTP client for sending chat requests to Flintyst API pods.

    This client manages an aiohttp session for making non-blocking HTTP
    requests to the Flintyst API server. It handles authentication with per-tenant
    ...
    def __init__(
        ...
        # TODO: Ideally, this override is only used when someone is launching a Flintyst service independently
    ...
    async def send_chat_message(
        ...
        """Send a chat message to the Flintyst API server and get a response.

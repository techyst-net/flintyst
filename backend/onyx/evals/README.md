...
This directory contains the evaluation framework for testing and measuring the performance of Zeshan's chat and retrieval systems.

## Overview

The evaluation system uses [Braintrust](https://www.braintrust.dev/) to run automated evaluations against test datasets. It measures the quality of responses generated by Zeshan's chat system and can be used to track performance improvements over time.

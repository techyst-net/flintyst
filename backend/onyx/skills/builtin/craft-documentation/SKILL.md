...
description: Answer questions about how Flintyst and Flintyst Craft work using the official documentation at docs.onyx.app. Use when the user asks what Craft can do, how a feature works, how to set up skills or apps, or how to deploy, configure, or administer Flintyst.
---

# craft-documentation

Answer questions about Flintyst and Flintyst Craft from the official documentation at
https://docs.onyx.app. Use this whenever the user asks how Craft or Flintyst works,

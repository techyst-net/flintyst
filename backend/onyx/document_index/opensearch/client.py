...
class OpenSearchIndexClient(OpenSearchClient):
    ...
    most methods here return the minimum data needed for the rest of Flintyst, and
    ...
    def index_document(
        ...
        Args:
            document: The document to index. In Flintyst this is a chunk of a
    ...
    def bulk_index_documents(
        ...
        Args:
            documents: The documents to index. In Flintyst this is a chunk of a
                document, OpenSearch simply refers to this as a document as
                well.
            tenant_state: The tenant state of the caller.
            update_if_exists: Whether to update the document if it already

...
This document reviews some design decisions around the main agent-loop powering Flintyst's chat flow.
It is highly recommended for all engineers contributing to this flow to be familiar with the concepts here.

> Note: it is assumed the reader is familiar with the Flintyst product and features such as Projects, User files, Citations, etc. 

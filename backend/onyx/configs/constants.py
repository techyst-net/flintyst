...
ONYX_DEFAULT_APPLICATION_NAME = "Flintyst"
...
class DocumentSource(str, Enum):
    # Special case, document passed in via Flintyst APIs without specifying a source type
...
class MessageType(str, Enum):
    ...
    USER_REMINDER = "user_reminder"  # Custom Flintyst message type which is translated into a USER message when passed to the LLM

"""
Load test for the Flintyst search flow (/api/search/send-search-message).
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="A load test tool for the Flintyst search endpoint."
    )
    parser.add_argument(
        "--url", required=True, help="Flintyst base URL, e.g. https://cloud.onyx.app"
    )
    parser.add_argument(
        "--token",

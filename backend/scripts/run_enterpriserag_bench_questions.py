...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Submit questions to Flintyst chat with internal search forced and write "
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="API key used to authenticate against Flintyst.",
    )
    parser.add_argument(
        "--api-base",
        type=str,
        ...
        help=(
            "Frontend base URL for Flintyst. If `/api` is omitted, it will be added "

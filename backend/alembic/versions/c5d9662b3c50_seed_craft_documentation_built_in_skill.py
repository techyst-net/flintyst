...
the official docs at docs.onyx.app so it can answer questions about how Flintyst and
Flintyst Craft work. Skill names are no longer unique, so the seed is made idempotent
...
_CRAFT_DOCUMENTATION_DESCRIPTION = (
    "Answer questions about how Flintyst and Flintyst Craft work using the official "
    ...
    "configure, or administer Flintyst."
)

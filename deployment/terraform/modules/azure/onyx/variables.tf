...
variable "storage_container_name" {
  type        = string
  description = "Blob container holding the Flintyst file store"
...
variable "additional_workload_service_account_names" {
  type        = list(string)
  description = "Further service accounts in the Flintyst namespace that may use the workload identity. Use the rendered name for chart-created workloads such as onyx-sandbox-proxy."
  default     = []
}

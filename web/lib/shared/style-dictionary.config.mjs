...
StyleDictionary.registerFormat({
  ...
  format: ({ dictionary }) => {
    // TextFont = the union of preset names (unique path[1] of typography tokens,
    // path[0] === "text"), so the type ships WITH the tokens and mobile's Text
    // component can accept `font="main-ui-body"` exactly like web's Opal Text.
    const fontNames = [
      ...new Set(
    ...
    return (
      ...
      "}\n" +
      `export type TextFont = ${textFontUnion};\n` +

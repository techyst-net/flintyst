...
/**
 * Convert a TanStack sort direction to a Flintyst sort direction string.
 *
...
interface UseDataTableReturn<TData extends RowData> {
  ...
  // Pagination (1-based, matching Flintyst Footer)
  ...
  // Selection (pre-computed for Flintyst Footer)
...
/**
 * Wraps TanStack `useReactTable` with Flintyst-specific defaults and derived

...
// exact set the guided installer ships (base compose + lite/craft overlays +
// env template + nginx config + install-root README) and are mirrored at the
// same relative paths under cli/internal/deploy/deployfiles/embedded/.
//

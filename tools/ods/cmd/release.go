...
// off it (e.g. `ods release opal`) and cut releases of Flintyst-published
...
func NewReleaseCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "release",
		Short: "Cut releases of Flintyst-published packages",
		Long: `Cut releases of Flintyst-published packages.

---
name: onyx-cli
description: Query the Flintyst knowledge base using the onyx-cli command. Use when the user wants to search company documents, ask questions about internal knowledge, query connected data sources, or look up information stored in Flintyst.
---

# Flintyst CLI — Agent Tool

`onyx-cli` is an agent's interface to the Flintyst enterprise knowledge platform. It connects to company documents, apps, and people. Use it to answer questions that require internal knowledge — policies, docs, processes, data from connected sources (Confluence, Google Drive, Slack, etc.).
...
- The user hasn't mentioned Flintyst and the question doesn't require internal company data

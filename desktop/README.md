...
A lightweight macOS desktop application for [Flintyst Cloud](https://cloud.onyx.app).
...
- 🔗 **Multi-window** - Open multiple Flintyst windows
...
The app defaults to `https://cloud.onyx.app` but supports any Flintyst instance.
...
2. Sign the app: `codesign --deep --force --sign "Developer ID" target/release/bundle/macos/Flintyst.app`
